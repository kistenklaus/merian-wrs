...
template <arithmetic T, std::floating_point P, std::integral I> struct IsAliasTableIndexError {
...
template <arithmetic T, std::floating_point P, std::integral I, generic_allocator Allocator> struct IsAliasTableError {
...
template <arithmetic T, std::floating_point P, std::integral I, generic_allocator Allocator>
IsAliasTableError<
    T,
    P,
    I,
...
assert_is_alias_table(std::span<const T> weights,
                      std::span<const AliasTableEntry<P, I>> aliasTable,
                      const T totalWeight,
...
assert_is_alias_table(std::span<const T> weights,
    ...
    return test::assert_is_alias_table<T, P, I, std::pmr::polymorphic_allocator<void>>(
