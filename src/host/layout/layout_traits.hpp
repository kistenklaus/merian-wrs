...
template<typename T>
concept IsPrimitiveArrayLayout = IsArrayLayout<T> && glsl::primitive_like<typename T::base_type>;


template<typename T>
concept IsComplexArrayLayout = IsArrayLayout<T> && !glsl::primitive_like<typename T::base_type>;
