...
class FallbackResource : public MemoryResource {
  public:
    FallbackResource(MemoryResource* primary, MemoryResource* fallback = getDefaultResource())
  ...
  private:
    MemoryResource* m_primaryUpstream;
    MemoryResource* m_fallbackUpstream;
};
