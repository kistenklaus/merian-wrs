...
template <typename P> using alias_table_entry = std::tuple<P, std::size_t>;
...
template <typename T, std::floating_point P, typename Allocator = std::allocator<void>>
std::vector<sweeping_internal::alias_table_entry<P>,
            typename std::allocator_traits<Allocator>::template rebind_alloc<
                sweeping_internal::alias_table_entry<P>>>
sweeping_alias_table(std::span<T> weights, const T totalWeight, const Allocator& alloc = {}) {
    using EntryAllocator = std::allocator_traits<Allocator>::template rebind_alloc<
        sweeping_internal::alias_table_entry<P>>;
    using Entry = sweeping_internal::alias_table_entry<P>;
...
template <typename T, typename P>
std::vector<sweeping_internal::alias_table_entry<P>,
            std::pmr::polymorphic_allocator<sweeping_internal::alias_table_entry<P>>>
sweeping_alias_table(std::span<T> weights,
                     const T totalWeight,
                     const std::pmr::polymorphic_allocator<void>& alloc) {
    return std::move(
        wrs::reference::sweeping_alias_table<T, P, std::pmr::polymorphic_allocator<void>>(
