...
class PartitionAndPrefixSumKernel {
    using weight_t = float;

  public:
    PartitionAndPrefixSumKernel(const merian::ContextHandle& context,
        ...
        const merian::ShaderModuleHandle shader =
            context->shader_compiler->find_compile_glsl_to_shadermodule(
                context, "src/wrs/kernels/decoupled_partition_and_prefix_sum.comp",
    ...
    void dispatch(vk::CommandBuffer cmd,
        ...
        auto partitionPrefixInfo = out_partitionPrefix->get_descriptor_info();
        ...
        m_pipeline->push_descriptor_set(
            cmd,
            {
                ...
                vk::WriteDescriptorSet{
                    {}, 2, 0, 1, vk::DescriptorType::eStorageBuffer, {}, &partitionPrefixInfo, {}},
                vk::WriteDescriptorSet{{},
                                       3,
                                       0,
                                       1,
                                       ...
                                       {}},
                vk::WriteDescriptorSet{
                    {}, 4, 0, 1, vk::DescriptorType::eStorageBuffer, {}, &pivotBuffer, {}},
            });
    ...
    vk::DeviceSize partitionDescriptorBufferSize(uint32_t workgroupCount) const {
        return sizeof(unsigned int) +
               (2 * sizeof(weight_t) + 2 * sizeof(unsigned int) + sizeof(unsigned int)) *
                   workgroupCount;
    }
