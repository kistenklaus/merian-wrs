...
static constexpr TestCase TEST_CASES[] = {
    ...
    /* TestCase{ */
    /*     .config = DecoupledPrefixPartitionConfig(512, 8, 32, BlockScanVariant::RANKED_STRIDED), */
    /*     .N = 1024 * 2048, */
    /*     .distribution = wrs::Distribution::PSEUDO_RANDOM_UNIFORM, */
    /*     .pivot = 0.5, */
    /*     .iterations = 1, */
...
static bool runTestCase(const TestContext& context,
    ...
    std::string testName = fmt::format("{{{},N={}}}", prefixPartitionConfigName(testCase.config), testCase.N);
