...
static const NamedConfig CONFIGURATIONS[] = {
    ...
    NamedConfig{
        ...
        .config =
            BlockScanConfig(512,
                            8,
                            BlockScanVariant::RANKED_STRIDED | BlockScanVariant::SUBGROUP_SCAN_SHFL,
                            1,
                            false),
        .flushL2 = true,
    }, //*/
    ...
    NamedConfig{
        .name = "RAKING-2-1-KoggeStone",
        .methodGroup = "RAKING",
        .config = BlockScanConfig(
            512, 2, BlockScanVariant::RAKING | BlockScanVariant::SUBGROUP_SCAN_SHFL, 1, false),
        .flushL2 = true,
    }, //*/
    NamedConfig{
        .name = "RAKING-2-1-KoggeStone",
    ...
    NamedConfig{
        .name = "RAKING-4-1-KoggeStone",
        .methodGroup = "RAKING",
        .config = BlockScanConfig(
            512, 4, BlockScanVariant::RAKING | BlockScanVariant::SUBGROUP_SCAN_SHFL, 1, false),
        .flushL2 = true,
    }, //*/
    NamedConfig{
        .name = "RAKING-4-2-KoggeStone",
        .methodGroup = "RAKING",
        .config = BlockScanConfig(
            512, 4, BlockScanVariant::RAKING | BlockScanVariant::SUBGROUP_SCAN_SHFL, 2, false),
        .flushL2 = true,
    }, //*/
    NamedConfig{
        .name = "RAKING-2-2-KoggeStone",
        .methodGroup = "RAKING",
        .config = BlockScanConfig(
            512, 2, BlockScanVariant::RAKING | BlockScanVariant::SUBGROUP_SCAN_SHFL, 2, false),
        .flushL2 = true,
    }, //*/
    NamedConfig{
        .name = "RAKING-1-2-KoggeStone",
        .methodGroup = "RAKING",
        .config = BlockScanConfig(
            512, 1, BlockScanVariant::RAKING | BlockScanVariant::SUBGROUP_SCAN_SHFL, 2, false),
        .flushL2 = true,
    }, //*/
    NamedConfig{
        .name = "RAKING-2-1-KoggeStone",
    ...
    NamedConfig{
        .name = "RANKED-2-1-KoggeStone",
        .methodGroup = "RANKED",
        .config = BlockScanConfig(
            512, 2, BlockScanVariant::RANKED | BlockScanVariant::SUBGROUP_SCAN_SHFL, 1, false),
        .flushL2 = true,
    }, //*/
    NamedConfig{
        .name = "RANKED-4-1-KoggeStone",
        .methodGroup = "RANKED",
        .config = BlockScanConfig(
            512, 4, BlockScanVariant::RANKED | BlockScanVariant::SUBGROUP_SCAN_SHFL, 1, false),
        .flushL2 = true,
    }, //*/
    NamedConfig{
        .name = "RANKED-4-2-KoggeStone",
        .methodGroup = "RANKED",
        .config = BlockScanConfig(
            512, 4, BlockScanVariant::RANKED | BlockScanVariant::SUBGROUP_SCAN_SHFL, 2, false),
        .flushL2 = true,
    }, //*/
    NamedConfig{
        .name = "RANKED-4-4-KoggeStone",
        .methodGroup = "RANKED",
        .config = BlockScanConfig(
            512, 4, BlockScanVariant::RANKED | BlockScanVariant::SUBGROUP_SCAN_SHFL, 4, false),
        .flushL2 = true,
    }, //*/
    NamedConfig{
        .name = "RANKED-2-2-KoggeStone",
        .methodGroup = "RANKED",
        .config = BlockScanConfig(
            512, 2, BlockScanVariant::RANKED | BlockScanVariant::SUBGROUP_SCAN_SHFL, 2, false),
        .flushL2 = true,
    }, //*/
    NamedConfig{
        .name = "RANKED-1-2-KoggeStone",
        .methodGroup = "RANKED",
        .config = BlockScanConfig(
            512, 1, BlockScanVariant::RANKED | BlockScanVariant::SUBGROUP_SCAN_SHFL, 2, false),
        .flushL2 = true,
    }, //*/
    NamedConfig{
        .name = "RANKED-STRIDED-2-1-KoggeStone",
        .methodGroup = "RANKED-STRIDED",
        .config =
            BlockScanConfig(512,
                            2,
    ...
    NamedConfig{
        .name = "RANKED-STRIDED-4-1-KoggeStone",
        .methodGroup = "RANKED-STRIDED",
        .config =
            BlockScanConfig(512,
                            4,
    ...
    NamedConfig{
        .name = "RANKED-STRIDED-4-2-KoggeStone",
        .methodGroup = "RANKED-STRIDED",
        .config =
            BlockScanConfig(512,
                            4,
    ...
    NamedConfig{
        .name = "RANKED-STRIDED-2-2-KoggeStone",
        .methodGroup = "RANKED-STRIDED",
        .config =
            BlockScanConfig(512,
                            2,
    ...
    NamedConfig{
        .name = "RANKED-STRIDED-1-2-KoggeStone",
        .methodGroup = "RANKED-STRIDED",
        .config =
            BlockScanConfig(512,
                            1,
    ...
    NamedConfig{
        .name = "RANKED-STRIDED-8-1-KoggeStone",
        .methodGroup = "RANKED-STRIDED",
        .config =
            BlockScanConfig(512,
                            8,
    ...
    NamedConfig{
        .name = "RANKED-STRIDED-8-2-KoggeStone",
        .methodGroup = "RANKED-STRIDED",
        .config =
            BlockScanConfig(512,
                            8,
    ...
    NamedConfig{
        .name = "RANKED-STRIDED-8-4-KoggeStone",
        .methodGroup = "RANKED-STRIDED",
        .config =
            BlockScanConfig(512,
                            8,
...
void benchmark(const merian::ContextHandle& context) {
    ...
    std::string path = "export/block_scan/block_scan_benchmark.csv";
    host::exp::CSVWriter<10> csv({"N", "block_size", "seq", "method", "group", "latency",
                                 "std_derivation", "throughput", "memory_throughput", "flushL2"},
                                path);
    for (const auto& r1 : results.entries) {
        ...
        for (const auto& r2 : r1.results.entries) {
            csv.pushRow(r2.N, r2.blockSize, r2.seq, method, r1.configuration.methodGroup,
                        r2.latency, r2.stdVar, r2.throughput, r2.memoryBandwidth, r2.flushL2);
        }
    }
}
